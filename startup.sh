...
<body>
    ...
    <section>
        <h2>About Me</h2>
        <p>I am slowly learning the aspects of cloud engineering. "Slowly" is the keyword in the sentence LOL</p>
        <!-- Embedded Image Requirement -->
        <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=1000" alt="Cloud Technology">
    </section>
    ...
    <footer>
        <h3>Contact</h3>
        <p>Email: cloudfighter72@gmail.com | CPG Armageddon Lab 2</p>
    </footer>
